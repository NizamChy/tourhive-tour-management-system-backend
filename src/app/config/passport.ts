      ...
      try {
        ...
        if (isGoogleAuthenticated) {
          return done(null, false, {
            message:
              "This email is registered with Google. Please use Google login. If you want to login with credentials at first login with Google and set a password for your gmail and then you can login with credentials.",
          });
        }
